...
riceBowlPose = lambda place: Pose(295/sqrt(2) - 250/sqrt(2), 295/sqrt(2) + 250/sqrt(2), 150 if place.casefold() == "down".casefold() else 250, -180, 0, 45)
waterBowlPose = lambda place: Pose(475/sqrt(2) - 250/sqrt(2), 475/sqrt(2) + 250/sqrt(2), 150 if place.casefold() == "down".casefold() else 250, -180, 0, 45)
